        ...
        try {
            ...
            if ($checkPasaran) {
                ...
                $data = [
                    ...
                    'tutup' => $checkPasaran->schedules->first() ? $checkPasaran->schedules->first()->closing_time : null,
                    'jadwal' => $checkPasaran->schedules->first() ? $checkPasaran->schedules->first()->open_time : null,
                ...
                $data = [
                    ...
                    'libur' => $paito->libur,
                    'url' => $paito->web,
                    'tutup' => $paito->schedules->first() ? $paito->schedules->first()->closing_time : null,
                    'jadwal' => $paito->schedules->first() ? $paito->schedules->first()->open_time : null,
