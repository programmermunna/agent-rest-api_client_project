    ...
    public function listClaimBonus()
    {
        try {
            ...
            if ($bonus_new_member->status_bonus == 1) {
                $checkBonusNewMember = TurnoverMember::where('member_id', $memberId)->where('constant_bonus_id', 4)->first();
                ...
                if ($checkBonusNewMember) {
                    ...
                    if ($checkBonusNewMember->status == 1 && $checkBonusNewMember->withdraw_id == null) {
