...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            // 'web_id' => [''], # kalau wajib, tinggal ['required'] # cuma dipakai di robocop
    ...
    {
        // throw new AuthorizationException(__('Only admin can update this user.'));
        throw new AuthorizationException(__('The requested resource was not found.'));
    }
}
