...
class UserController extends Controller
{
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return redirect()->back()->withFlashSuccess(__('Admin user '. $user->name .' was successfully created.'));
    }
    ...
    public function update(UpdateUserRequest $request, User $user)
    {
        ...
        return redirect()->back()->withFlashSuccess(__('Admin user '. $user->name .' was successfully updated.'));
    }
