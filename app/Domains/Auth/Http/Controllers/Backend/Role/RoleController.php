...
class RoleController extends Controller
{
    ...
    public function store(StoreRoleRequest $request)
    {
        ...
        return redirect()->route('admin.auth.role.index')->withFlashSuccess(__('Admin Level '. $request->name .' was successfully created.'));
    }
    ...
    public function update(UpdateRoleRequest $request, Role $role)
    {
        ...
        return redirect()->route('admin.auth.role.index')->withFlashSuccess(__('Admin Level '. $role->name .' was successfully updated.'));
    }
    ...
    public function destroy(DeleteRoleRequest $request, Role $role)
    {
        ...
        return redirect()->route('admin.auth.role.index')->withFlashSuccess(__('Admin Level '. $role->name .' was successfully deleted.'));
    }
}
