...
class TogelBlokAngka extends Model
{
	...
	protected $fillable = [
		'constant_provider_togel_id', 'number_1', 'number_2', 'number_3', 'number_4', 'number_5', 'number_6', 'game', 'created_by', 'updated_by', 'deleted_by', 'created_at', 'updated_at', 'deleted_at'
	];
