...
class CreateConstantProviderTogelWlTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('constant_provider_togel_wl', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('constant_provider_togel_wl');
    }
}
